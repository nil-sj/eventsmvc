...
public class EventCategoryController {
    ...
    public String displayAllCategories(Model model) {
        ...
        model.addAttribute("subTitle", "All Event Categories");
    ...
    public String renderCreateEventCategoryForm(Model model) {
        model.addAttribute("title", "Coding Events - Thymeleaf");
        model.addAttribute("subTitle", "Form: Create An Event Category");
    ...
    public String processCreateEventCategoryForm(@Valid @ModelAttribute EventCategory eventCategory, Errors errors, Model model) {
        ...
        if (errors.hasErrors()) {
            model.addAttribute("title", "Coding Events - Thymeleaf");
            model.addAttribute("subTitle", "Form: Create An Event Category - Correct the Errors!");
